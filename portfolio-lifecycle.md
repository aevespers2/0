...
2. **QuantumStateObjects:** remediate the three current PR #7 findings, complete evidence-based Issue #8 security adjudication, rerun exact-head evidence, then require explicit merge authorization and merged-head acceptance.
